...
(function () {
    ...
    function speakerTimeUi(settings) {
        ...
        group$ = APP_ui.li('', 'col s3 m3 l2').append(
            APP_ui.i('group', 'material-icons')).css('cursor', 'pointer').click(manageUsers);

        reset$ = APP_ui.li('', 'col s3 m3 l2').text('reset').css('cursor', 'pointer').click(resetPlay);

        settings$ = APP_ui.li('', 'col s3 m3 l2').append(
            APP_ui.i('settings', 'material-icons large')).css('cursor', 'pointer').click(manageMode);

        next$ = APP_ui.li('', 'col s3 m3 l2').append(
            APP_ui.i('forward', 'material-icons large')).css('cursor', 'pointer').click(nextUser);
